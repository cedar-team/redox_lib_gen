...
class CancelPatientPCPLocation(RedoxAbstractModel):
    ...
    FacilityIdentifiers: List["CancelPatientPCPLocationFacilityIdentifier"] = Field(
        None
    )
...
CancelPatientPCPLocation.update_forward_refs()
...
CancelVisitAdmittingProviderLocation.update_forward_refs()
